<?php
define("CONTROLADOR_PUBLICIDAD","ControlLogin.php"); //const CONTROLLER_PUBLICIDAD="ControladorPublicidad"; //Controlador x default
define("CONTROLADOR_SISTEMA","ControlAdminLTE");
/*
